# -*- coding: utf-8 -*-
# deploy web system automatically
...
app_name = 'web'
app_back_path = '/usr/local/projectback/web'
...
# start tomcat 
    print ssh.runcmd('sed -i \'s/pay_url=.*/' + 'pay_url=http:\/\/'+ hostname + ':' + finance_port + '\/finance\/dispatch\/dispatch.action'+ '/g\'' + ' ' + app_config_path + '/' + app_config_file1).decode('UTF-8')
